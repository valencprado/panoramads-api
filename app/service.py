...
def get_structured_data():
    try:
        ...
        perguntas = ["idade", "genero", "semestre", "atuacao_atual", "modalidade_trabalho", "regiao_trabalho", "regiao", "porte_empresa", "area_atual", "area_desejo", "satisfacao_trabalho", "dificuldade_trabalho"]
